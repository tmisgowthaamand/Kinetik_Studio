        ...
        <>
            ...
            >
                <video
                    ...
                    style={{ objectFit: 'cover', backgroundColor: '#0a0a0a' }}
                >
                ...
                <div className="home-header__title">
                    <h1 className="vimeo-hero__title" ref={titleRef} onClick={(e) => e.stopPropagation()}>
                        ...
                        {/* "culture" italic */}
                        <span className="vimeo-hero__word"><em>culture </em></span>
                        ...
                        {/* "hyper-digital" + ⑤ pink star (no spin) + oval underline */}
                        <span className="vimeo-hero__word is--relative">
