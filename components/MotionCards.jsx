...
export default function MotionCards() {
    ...
    useEffect(() => {
        const ctx = gsap.context(() => {
            ...
            // Entry Animations: Sticker Pop & Underline Draw (All Screens)
    ...
    return (
        ...
        >
            {/* ─── Part 1: Bold Heading Text with SVG Sticker ─── */}
            <div className="motion-card__heading">
                <h2 className="motion-card__title">
                    a studio built
                    <br />
                    for the infinite feed.
                </h2>
                <p className="motion-card__subtitle">
                    from viral drops to 3D worlds.
                    {/* SVG sticker — top-right area */}
            ...
            <div className="motion-card__cards-area">
                ...
                <div ref={containerRef} className="motion-card__cards">
                    ...
                    <div className="motion-card__card motion-card__card--1">
                        ...
                        <span className="motion-card__mobile-badge badge--pink">hyper visual 3D</span>
                    </div>

                    {/* Card 2: Streetwear Editorial */}
                    <div className="motion-card__card motion-card__card--2">
                        ...
                        <span className="motion-card__mobile-badge badge--yellow">bland is the enemy</span>
                    </div>

                    {/* Card 3: Cyberpunk Setup */}
                    <div className="motion-card__card motion-card__card--3">
                        ...
                        <span className="motion-card__mobile-badge badge--orange">culture moves fast</span>
                    </div>

                    {/* Card 4: Modern Architecture */}
                    <div className="motion-card__card motion-card__card--4">
                        ...
                        <span className="motion-card__mobile-badge badge--green">crafting the impossible</span>
                    </div>
                </div>

                {/* Floating labels for Desktop (hidden on mobile swipe) */}
                <div className="motion-card__floating-labels">
                    <div className="motion-card__floating-label motion-card__floating-label--pink">
                        <p className="motion-card__floating-text">bland is the enemy</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--orange">
                        <p className="motion-card__floating-text">culture moves fast</p>
                    </div>
                    <div className="motion-card__floating-label motion-card__floating-label--red">
                        <p className="motion-card__floating-text">crafting the impossible</p>
                    </div>
                </div>
            </div>
            ...
            <div className="motion-card__footer-text">
                <p className="motion-card__description">
                    To lead tomorrow, you have to break through the noise of today.
                    We operate across the entire modern creative spectrum — from viral social engines
                    to immersive 3D web platforms and culture-defining CGI campaigns.
                </p>
            </div>
        </section>
    );
